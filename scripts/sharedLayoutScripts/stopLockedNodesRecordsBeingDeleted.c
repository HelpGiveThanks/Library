January 18, 2018 15:59:04 Library.fmp12 - stopLockedNodesRecordsBeingDeleted -1-
sharedLayoutScripts: stopLockedNodesRecordsBeingDeleted
#
#
...
End If
Show Custom Dialog [ Message: "The test subject — " & TEMP::DEFAULTNodeTestSubjectName & " — is locked. To unlock, A)
go back to the setup node tag menu. B) Select this test subject. C) Click 'lock' and enter the password."; Default Button: “OK”,
Commit: “Yes” ]
#
Halt Script
#
