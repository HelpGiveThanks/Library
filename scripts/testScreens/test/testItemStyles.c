...
#
#
#This script (triggered by the H button) inserts
#before after publication dashes, and any test
#item with a publication dash and a space is
#conditionally formatted as bold and grey.
