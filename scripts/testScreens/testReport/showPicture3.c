January 15, 2018 15:33:24 Library.fmp12 - showPicture3 -1-
test: report: showPicture3
#
#Show picture in picture window...
Set Variable [ $$PictureOnReportLayout; Value:testlearnReportTags 3::_Ltestlearn ]
Set Variable [ $$fileLocation; Value:Case ( testlearnReportTags 3::picture ≠ "" ; "TLpicture" ;
Case (
refShowMediaReport 3::picture ≠ "" ; "database" ;
refShowMediaReport 3::kfileLocation ≠ "" and refShowMediaReport 3::fileName ≠ "" and refShowMediaReport 3::showMedia = "" ;
"harddrive" ;
refShowMediaReport 3::URL ≠ "" and refShowMediaReport 3::showMedia ≠ "" ; "web" ;
"none" )
) ]
#
