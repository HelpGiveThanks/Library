...
Show Custom Dialog [ Message: "Find notes linked to this note?" & ¶ & "OR" & ¶ & "Find other notes?"; Default
Button: “other”, Commit: “No”; Button 2: “linked”, Commit: “No”; Button 3: “cancel”, Commit: “No” ]
Else
If [ testlearn::brainstormCasePoint = "" ]
Show Custom Dialog [ Message: "Find inventory with the same in/on tag as this item?" & ¶ & "OR" & ¶ & "Find
other inventory items?"; Default Button: “other”, Commit: “No”; Button 2: “tagged”, Commit: “No”; Button 3:
“cancel”, Commit: “No” ]
Else
Show Custom Dialog [ Message: "Find inventory tagged with this in/on tag?" & ¶ & "OR" & ¶ & "Find other
inventory items?"; Default Button: “other”, Commit: “No”; Button 2: “tagged”, Commit: “No”; Button 3: “cancel”,
Commit: “No” ]
End If
End If
#
