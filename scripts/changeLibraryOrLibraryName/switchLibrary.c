...
Open URL [ Substitute ( Case ( Get ( SystemPlatform ) = - 2 ; $library ; Substitute ( $library ; "file:/" ; "file://" ) ) ; " " ; "%20" ) ]
[ No dialog ]
#
...
If [ Get (LastError) = 5 ]
#
Open URL [ Substitute ( Case ( Get ( SystemPlatform ) = - 2 ; $library ; Substitute ( $library ; "file:/" ; "file:///volumes/" ) ) ; " " ; "%20" ) ]
[ No dialog ]
#
If [ Get (LastError) = 5 ]
Select Window [ Name: "Setup"; Current file ]
