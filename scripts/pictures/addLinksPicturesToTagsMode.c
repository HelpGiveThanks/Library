...
enter the password to unlock it and then you will be able to add pictures and links to it."; Buttons: “OK” ]
Exit Script [ ]
End If
...
End If
End If
December 28, ଘ౮27 16:02:59 Library.fp7 - addLinksPicturesToTagsMode -1-
