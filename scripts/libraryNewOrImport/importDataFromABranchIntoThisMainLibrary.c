...
#changes made in library being imported.
Show Custom Dialog [ Message: "IMPORTANT: This import can change — update, overwrite, etc. — records in this library."; Default
Button: “OK”, Commit: “No”; Button 2: “cancel”, Commit: “No” ]
If [ Get ( LastMessageChoice ) = 2 ]
Exit Script [ ]
End If
Show Custom Dialog [ Message: "For example, if a record's text in the library being imported was changed from 'Apple' to 'Orange,'
then the record in this library will also be changed to 'Orange.'"; Default Button: “OK”, Commit: “No”; Button 2: “cancel”, Commit:
“No” ]
If [ Get ( LastMessageChoice ) = 2 ]
Exit Script [ ]
End If
...
Show All Records
If [ Get (FoundCount) = 0 ]
Import Records [ Source: “$filepath”; Target: “aboutLibrary”; Method: Add; Character Set: “Unicode”; Field Mapping: Source field
1 import to aboutLibrary::_LaboutLibrary
...
[ No dialog ]
Else
Import Records [ Source: “$filepath”; Target: “aboutLibrary”; Method: Update matching; Add remaining; Character Set: “Unicode”;
Field Mapping: Source field 1 match with aboutLibrary::_LaboutLibrary
Source field 2 import to aboutLibrary::_Number
Source field 3 import to aboutLibrary::URL
Source field 4 import to aboutLibrary::publicationDate
Source field 5 import to aboutLibrary::kcreatorNode
