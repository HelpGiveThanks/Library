July 21, 2018 13:49:53 Library.fmp12 - archiveChecklist -1-
tagMenu: archiveChecklist
#
#
...
#archive them.
If [ $$noFT_ItemsFound = "" ]
Show Custom Dialog [ Message: "Now archiving check and text items, not form items. Click the +form button to add form
items."; Default Button: “OK”, Commit: “Yes” ]
End If
#
#
#
...
Show Custom Dialog [ Message: "The archive will be added below the current text. You may need to scroll down to
see it."; Default Button: “OK”, Commit: “Yes”; Button 2: “cancel”, Commit: “No” ]
Else
Show Custom Dialog [ Message: "The archive will be added below the current text. You may need to scroll down to
see it."; Default Button: “OK”, Commit: “Yes”; Button 2: “cancel”, Commit: “No” ]
End If
...
Set Variable [ $tag; Value://TextStyleAdd ( "✓ " ; Bold ) & tagMenus::tag
"✓ " & tagMenus::tag ]
Else
...
TextColor ( TextSize ( TextFont ( tagMenuTestItemGroup::name ; "Arial" ) ; 18 ) ; RGB ( 125 ; 125 ; 125 ) )
& ¶ & $tag ]
End If
#
...
#then just added it.
If [ $form = "" ]
Set Variable [ $form; Value:TextColor ( TextSize ( "Checklist Archived " & Get ( CurrentTimeStamp ) ; 16 ) ; RGB
( 125 ; 125 ; 125 ) )
& ¶ & $tag ]
#
