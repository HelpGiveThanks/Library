...
#tells the system that a no ﬁnd keyword, has ﬁnds.
...
#At ﬁrst the loop is conﬁned to looking at all keywords
...
#
#
#Report on ﬁndings and if none delete keyword.
#
...
#
#A ﬁnd is performed to show the remaining keyword
